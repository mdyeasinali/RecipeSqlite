package com.hitechwebdesign.yeasin.recipesqlite.session;
...
public class MyPreferencesHelperSinglaton {

    private static final String SETTINGS_NAME = "default_settings";
    private static MyPreferencesHelperSinglaton sSharedPrefs;
    ...
    public  enum Key {
         ...
         */
        KEY_USER_NAME, KEY_USER_EMAIL, KEY_USER_IMAGE, KEY_USER_COUNTRY, KEY_USER_ADD, KEY_USER_USERNAME, KEY_USER_ID
    }

    private MyPreferencesHelperSinglaton(Context context) {
        mPref = context.getSharedPreferences(SETTINGS_NAME, Context.MODE_PRIVATE);
    }


    public static MyPreferencesHelperSinglaton getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new MyPreferencesHelperSinglaton(context.getApplicationContext());
        }
        return sSharedPrefs;
    }

    public static MyPreferencesHelperSinglaton getInstance() {
        if (sSharedPrefs != null) {
            return sSharedPrefs;
        }
    ...
    public static void setVisited(Context c) {
        final SharedPreferences prefs = c.getSharedPreferences(SETTINGS_NAME,
